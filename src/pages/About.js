    ...
    return (
        <div>
            ...
            <div className="about_container">
                <div className="about">
                    <h1>About Us</h1>
                    <p className="desciption">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor Lorem ipsum dolor sit amet consetetur sadipscing elitr</p>
